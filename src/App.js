		...
		return(
			<div>
				<div className="banner text-white site-header">
					<div className="bg-dark-overlay layer"></div>
          <CustomNavigation />
					<NewsletterMailchimp1 headertag1="Learn the Natural way,  Speak like a Native" />
				</div> {/* banner */}
			</div>
		);
	}
			...
			<div>
				<nav className="navbar navbar-expand-lg navbar-togglable navbar-dark pt-lg-4">
					 <div className="container">
						 {/* Brand*/}
						 <Link to ="/" className="navbar-brand" ><img src={require('./images/logo.png')} alt="logo image" className="img-fluid"></img></Link>
						 {/* Toggler*/}
						 ...
						 <div className="collapse navbar-collapse" id="navbarCollapse">
							 <ul className="navbar-nav ml-auto">
								 ...
								 <li className="ml-lg-3 sign-up py-lg-0 py-3">
									 <Link to = "/Signup" className="btn dark-btn small-btn">Sign Up</Link>
								 </li>
							 </ul>
						 </div> {/*.navbar-collapse */}
					 </div> {/* / .container */}
...
class NewsletterMailchimp1 extends React.Component{
	render(){
		return(
							 ...
							 <div className="col-lg-9 col-xl-6 col-sm-12 col-md-9">
								 <div className="banner-text position-relative d-flex flex-column justify-content-center">
									 ...
									 <form className="form form-newsletter input-group" method="post" action="index.html">
													 ...
													 <Link to ="/Main" className ="learn-more text-white lead font-weight-bold d-table">
													 <span className=""> Learn More </span>
													 <i className="fa fa-angle-down d-table-cell align-bottom pl-2"></i></Link>
												 </div> {/* }/banner text */}
							 </div>{/* }/col */}
						 </div> {/* /row */ }
					 </div> {/* }/container */}
							 ...
							 <div className="offset-lg-1 col-lg-4 col-md-5 col-sm-8 footer-form">
								 ...
								 <form className="form form-newsletter input-group mb-4" method="post" action="index.html">
												 ...
												 <div className="footer-social d-flex justify-content-between">
													 <button className="btn btn-social btn-facebook" onClick={()=>window.open('https://www.facebook.com/TheMunsel')}> {/*window.location.href*/}
															 <i className="fab fa-facebook-f"></i> Facebook
													 </button>
													 <button className="btn btn-social btn-instagram" onClick={()=>window.open('https://www.instagram.com/themunsel')}>
															 <i className="fab fa-instagram"></i> Instagram
													 </button>
													 <button className="btn btn-social btn-youtube" onClick={()=>window.open('https://www.youtube.com/channel/UCoBQcPMruzmRdfE5sdAxk5w')}>
